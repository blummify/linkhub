      ...
      <main className="pt-32 pb-24 px-6">
        ...
        <section className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-start mb-32">
          <div className="bg-surface-container-low rounded-xl p-8 flex flex-col h-full border-t-4 border-transparent">
            ...
            <button className="w-full py-4 rounded-full font-semibold text-primary bg-surface-container-lowest hover:bg-surface-bright transition-colors cursor-pointer">
              Start Free
            </button>
          </div>
          <div className="relative bg-surface-container-lowest rounded-xl p-8 flex flex-col h-full ring-2 ring-primary/20 shadow-2xl scale-105 z-10">
            ...
            <button className="w-full py-4 rounded-full font-semibold text-on-primary editorial-gradient hover:opacity-90 transition-all active:scale-95 cursor-pointer">
              Upgrade to Pro
            </button>
          </div>
          <div className="bg-surface-container-low rounded-xl p-8 flex flex-col h-full">
            ...
            <button className="w-full py-4 rounded-full font-semibold text-on-surface-variant bg-surface-container-highest hover:bg-surface-dim transition-colors cursor-pointer">
              Contact Sales
            </button>
          </div>
        </section>
