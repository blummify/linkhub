...
export function PlanCard({ plan }: PlanCardProps) {
      ...
      >
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 20 }}>
          <div>
            ...
            <div style={{ fontFamily: FONT_SERIF, fontStyle: "italic", fontSize: 40, lineHeight: 1, letterSpacing: "-0.02em", margin: "8px 0 6px", color: "#0b1020" }}>
              Free
            </div>
            <div style={{ fontSize: 14, color: "#3a4474" }}>
              5 links · 1k views · no custom domain
            </div>
          </div>
          <button
            style={{
  ...
  return (
    <div
      ...
      style={{
        background: "linear-gradient(135deg, #0b1020, #1e2a8a)",
        padding: "22px 24px",
        border: "none",
    ...
    >
      ...
      <div
        style={{
          ...
          background: "radial-gradient(circle, rgba(104,115,255,0.45), transparent 70%)",
          pointerEvents: "none",
        }}
      />
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 20, position: "relative" }}>
        <div>
          ...
          <div style={{ fontFamily: FONT_SERIF, fontStyle: "italic", fontSize: 40, lineHeight: 1, letterSpacing: "-0.02em", margin: "8px 0 6px", color: "white" }}>
            Pro
          </div>
          <div style={{ fontSize: 14, color: "rgba(255,255,255,0.8)" }}>
            <strong style={{ color: "white", fontWeight: 600 }}>$12</strong> / month · billed annually
          </div>
        </div>
        <button
          style={{
            display: "inline-flex", alignItems: "center", gap: 7,
            background: "white", color: "#1e2a8a",
            border: "none", borderRadius: 8, padding: "8px 14px",
            fontSize: 13, fontWeight: 500, cursor: "pointer", whiteSpace: "nowrap",
          }}
        >
      ...
      >
        <span>
          Renews on{" "}
          <strong style={{ color: "white", fontWeight: 500 }}>December 14, 2026</strong>
        </span>
        <button
          style={{
