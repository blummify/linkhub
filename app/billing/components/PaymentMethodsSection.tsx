...
const BRAND: Record<PaymentCard["brand"], { label: string; bg: string; name: string }> = {
  ...
  return (
    <button
      ...
      style={{
        ...
        background: "transparent", border: "1px solid #d6dae9",
        color: "#3a4474", display: "grid", placeItems: "center", cursor: "pointer",
      }}
    >
      {children}
    </button>
          ...
          return (
            <div
              ...
              style={{
                ...
                padding: "13px 15px",
                border: "1px solid #eef0f7", borderRadius: 12,
                background: "#f7f8fc",
              }}
            >
              {/* Brand chip */}
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ fontSize: 13.5, fontWeight: 500, color: "#0b1020", display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  {card.isDefault && (
                    <span style={{
                      fontSize: 10, fontWeight: 600, color: "#2a37c0",
                      background: "#e6e9ff", padding: "2px 7px", borderRadius: 99, letterSpacing: "0.04em",
                    }}>
                      DEFAULT
                    </span>
                  )}
