      ...
      <nav className="fixed top-0 w-full z-50 bg-white/70 backdrop-blur-xl">
        <div className="flex justify-between items-center max-w-7xl mx-auto px-6 h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link
              className="font-inter text-sm font-medium text-indigo-700 border-b-2 border-indigo-600 pb-1"
              href="/features"
            >
              Features
            </Link>
          ...
          <div className="flex items-center space-x-4">
            <button className="font-inter text-sm font-medium text-slate-600 hover:text-indigo-600 transition-colors px-4 py-2">
              Login
            </button>
            <button className="bg-gradient-to-br from-primary to-primary-container text-white px-6 py-2 rounded-full font-inter text-sm font-medium transition-transform scale-95 active:scale-90 duration-200">
              Sign Up
            </button>
          </div>
        </div>
